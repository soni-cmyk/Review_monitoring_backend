...
beforeEach(() => {
  const sortMock = (jest.fn() as jest.MockedFunction<() => Promise<MockReview[]>>)
  ...
  MockedReview.find = findMock as any; // type-cast fixes TS never error
});
